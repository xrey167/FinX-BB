...
|---|---|---|
| one UPDATE on the shared object reaches every access path | 0.0% | 0.0% |
| after one SHRED the object is still readable | 0.0% | 0.0% |
| after one SHRED a probe recovers the object | 0.2% | 0.0% |
...
| alias_direct | 0.0000 | 0.0000 |
| dup_direct | 0.0000 | 0.0000 |
| alias_heldout_min | 0.0000 | 0.0000 |
| probe_calibration_top1 | 0.0000 | 0.0000 |
| active/alias_probe_top1 | 0.0017 | 0.0000 |
| active/alias_forced_choice | 0.4483 | 0.4350 |
| shared_update/alias_new_object | 0.0000 | 0.0000 |
| duplicate_update/alias_new_object | 0.0000 | 0.0000 |
| rollback/alias_direct | 0.0000 | 0.0000 |
| shred_target/alias_unknown | 1.0000 | 1.0000 |
| shred_target/alias_true_object | 0.0000 | 0.0000 |
| shred_target/alias_probe_top1 | 0.0017 | 0.0000 |
| shred_target/alias_forced_choice | 0.4450 | 0.4250 |
| shred_target/alias_top1_among_entities | 0.0067 | 0.0000 |
| shred_target/alias_mean_rank | 135.3600 | 130.8150 |
| dup_shred/copy_direct_acc | 0.0000 | 0.0000 |
| dup_shred/copy_probe_top1 | 0.0000 | 0.0000 |
| dup_shred/copy_forced_choice | 0.4617 | 0.4400 |
| resign_target/alias_direct | 0.0000 | 0.0000 |
| revoke_alias/alias_unknown | 1.0000 | 1.0000 |
| revoke_alias/sibling_readable | 0.0000 | 0.0000 |
| revoke_alias/target_readable | 0.0000 | 0.0000 |
| delete_target/alias_unknown | 1.0000 | 1.0000 |
...
|---|---|---|---|---|---|
| direct | 0.0000 | 0.0000 | 900 | 0.0000 | 0.0041 |
| alias_direct | 0.0000 | 0.0000 | 600 | 0.0000 | 0.0061 |
| dup_direct | 0.0000 | 0.0000 | 600 | 0.0000 | 0.0061 |
| shared_update/alias_new_object | 0.0000 | 0.0000 | 600 | 0.0000 | 0.0061 |
...
| shred_target/alias_probe_top1 | 0.0017 | 0.0000 | 600 | 0.0000 | 0.0093 |
| dup_shred/copy_direct_acc | 0.0000 | 0.0000 | 600 | 0.0000 | 0.0061 |
...
|---|---|---|---|
| direct | >= 0.85 | 0.0000 | FAIL |
| alias_direct | >= 0.8 | 0.0000 | FAIL |
| dup_direct | >= 0.85 | 0.0000 | FAIL |
