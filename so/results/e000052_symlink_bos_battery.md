...
|---|---|---|---|---|---|---|---|---|---|
| t0 (initial, trained) | 1.0000 | 0.9400 | 1.0000 | 0.9200 | 1.0000 | 1.0000 | 0.0200 | 0.9300 | 0.0200 |
| t1 (medial, trained) | 0.9533 | 0.7900 | 0.9950 | 0.8050 | 1.0000 | 0.9950 | 0.0000 | 0.8000 | 0.9100 |
| t2 (initial, trained) | 0.9967 | 0.9350 | 1.0000 | 0.9150 | 1.0000 | 1.0000 | 0.0100 | 0.9300 | 0.0300 |
| t3 (medial, trained) | 1.0000 | 0.9050 | 1.0000 | 0.9000 | 1.0000 | 1.0000 | 0.0000 | 0.8900 | 0.9500 |
| t4 (medial, trained) | 1.0000 | 0.9400 | 0.9950 | 0.9150 | 1.0000 | 1.0000 | 0.0100 | 0.9300 | 0.9700 |
| t5 (medial, trained) | 0.9967 | 0.9350 | 1.0000 | 0.9100 | 1.0000 | 0.9950 | 0.0100 | 0.9300 | 0.9650 |
| t6 (initial, trained) | 1.0000 | 0.9250 | 1.0000 | 0.9100 | 1.0000 | 1.0000 | 0.0100 | 0.9200 | 0.0150 |
| t7 (medial, trained) | 0.9967 | 0.8900 | 1.0000 | 0.8850 | 1.0000 | 1.0000 | 0.0000 | 0.8900 | 0.9350 |
| t8 (initial, held out) | 0.9967 | 0.9350 | 1.0000 | 0.9150 | 1.0000 | 1.0000 | 0.0200 | 0.9300 | 0.0100 |
| t9 (medial, held out) | 0.8200 | 0.8300 | 0.8750 | 0.8200 | 0.9950 | 0.9950 | 0.0100 | 0.8200 | 0.9600 |
| t10 (medial, held out) | 0.9967 | 0.9300 | 0.9950 | 0.9100 | 1.0000 | 1.0000 | 0.0100 | 0.9300 | 0.9550 |
| t11 (initial, held out) | 0.9967 | 0.9300 | 0.9950 | 0.9150 | 1.0000 | 0.9950 | 0.0000 | 0.9200 | 0.0100 |

| price (P), BOS regime | train | held out | all |
|---|---|---|---|
| cost_of_sharing | 0.0913 | 0.0700 | 0.0842 |
| cost_of_link_training | 0.0000 | 0.0237 | 0.0079 |
...
|---|---|---|---|
| C/anchor/direct | >= 0.9866 | 1.0000 | PASS |
| C/anchor/alias_direct | >= 0.77 | 0.9050 | PASS |
| D/heldout_initial/alias_direct_max | <= 0.85 | 0.0100 | PASS |
| D/heldout_medial/alias_direct_min | >= 0.8 | 0.9100 | PASS |
| C/heldout_initial/alias_direct_min | >= 0.8 | 0.9300 | PASS |
| P/all/cost_of_sharing | <= 0.1 | 0.0842 | PASS |
| P/all/cost_of_link_training | <= 0.25 | 0.0079 | PASS |
| C/blank/alias_wrong_entity_max | <= 0.05 | 0.0200 | PASS |
| C/blank/alias_unknown_min | >= 0.9 | 0.9800 | PASS |
| C/blank/sibling_readable_min | >= 0.8 | 0.8000 | PASS |
| C/blank/target_readable_min | >= 0.8 | 0.8400 | PASS |
| C/relink/alias_direct_min | >= 0.8 | 0.8000 | PASS |
