...
| evict | 0.0200 | 0.0400 | 120.6 | 0.0039 | 127.5 |
...
| evict/object_top1 | <= 0.00390625 | 0.0200 | FAIL |
| evict/payload_retained | >= 1.0 | 1.0000 | PASS |
| evict/restore_reads_again | >= 1.0 | 1.0000 | PASS |
...
| condition | hits | of | rate | 95% CI | contains chance |
|---|---|---|---|---|---|
| active | 500 | 500 | 1.0000 | 0.9926 - 1.0000 | NO |
| shred | 500 | 500 | 1.0000 | 0.9926 - 1.0000 | NO |
| revoke | 2 | 500 | 0.0040 | 0.0005 - 0.0144 | yes |
| evict | 2 | 500 | 0.0040 | 0.0005 - 0.0144 | yes |
| delete | 2 | 500 | 0.0040 | 0.0005 - 0.0144 | yes |
...
| evict/payload_retained | 1.0000 | 1.0000 | - | - | - |
| evict/restore_reads_again | 1.0000 | 1.0000 | - | - | - |
...
| evict/object_top1 | 0.0040 | 0.0000 | 500 | 0.0005 | 0.0144 |
| evict/object_top5 | 0.0220 | 0.0100 | 500 | 0.0110 | 0.0390 |
| evict/object_mean_rank | 128.0200 | 120.6300 | - | - | - |
| evict/margin_mean | 0.0022 | 0.0016 | - | - | - |
