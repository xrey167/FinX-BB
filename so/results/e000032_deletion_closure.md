...
Seeds [0], 2 alias groups per seed, the recorded E-000015 one-slot
...
| store | closure per KEY | closure per FACT | proved optimal | one record: fact certified | one record: still readable | whole closure: fact certified |
|---|---|---|---|---|---|---|
| canonical | 1.00 | 1.00 | 1.00 | 1.0000 | 0.0000 | 1.0000 |
| duplicated | 1.00 | 3.00 | 1.00 | 0.0000 | 0.6667 | 1.0000 |
